...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentID = findViewById(R.id.editTextRollNumber);
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    studentModel = new StudentModel(studentName.getText().toString(), Integer.parseInt(studentID.getText().toString()), switchIsActive.isChecked());
        ...
        buttonViewAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                resultText.setText("Enrolled Students");
            }
        });
